...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("স্বাধীন বস কাকে চুষদে চান এমন 1 জনকে @ম্যানশন করতে হবে", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("চুম্মা খাও স্বধীনের ");
setTimeout(() => {a({body: "খাংকির পোলা তর মারে চুডি 🥰।" + " " + name, mentions: arraytag})}, 3000);
...
setTimeout(() => {a({body: "স্বাধীন তোর বাপ বুচ্ছো  🤝" + " " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a({body: "Hiস্বধীনের এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
